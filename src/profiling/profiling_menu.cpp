...
void plot()
{
  ...
  {        
    ...
    path[0] = "src/profiling/logs/operators/";
    path[1] = "src/profiling/logs/runtime/";
    path[2] = "src/profiling/logs/memory/";

    std::vector< std::string > gnufile (3);
    gnufile[0] = "src/profiling/plot/operators_plot.gp";
    gnufile[1] = "src/profiling/plot/runtime_plot.gp";
    gnufile[2] = "src/profiling/plot/memory_plot.gp";
