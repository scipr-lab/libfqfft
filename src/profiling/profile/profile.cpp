...
#include "../../evaluation_domain/domains/geometric_sequence_domain.hpp"
#include "../../evaluation_domain/domains/arithmetic_sequence_domain.hpp"
...
int main(int argc, char* argv[])
{
  ...
  path[0] = "src/profiling/logs/runtime/" + datetime + "/";
  path[1] = "src/profiling/logs/memory/" + datetime + "/";
  path[2] = "src/profiling/logs/operators/" + datetime + "/";
